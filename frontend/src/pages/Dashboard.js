...
export default function Dashboard() {
    ...
    return (_jsxs(AppShell, { user: user, onLogout: logout, topBar: {
        ...
        }, children: [err && (_jsx("div", { className: "card errorBanner", style: { border: "1px solid rgba(239,68,68,0.3)" }, children: err })), _jsx("div", { className: "pageContainer", children: _jsxs(Routes, { children: [_jsx(Route, { path: "dashboard", element: _jsx(OverviewPage, { areas: areas, accessMap: accessMap, loading: areasLoading, isSuperAdmin: user?.role === "SUPER_ADMIN", onOpenAccess: () => navigate(`/${locale}/access`), onOpenDocuments: () => navigate(`/${locale}/documents`), onOpenAsk: () => navigate(`/${locale}/ask`) }) }), _jsx(Route, { path: "areas", element: _jsx(Navigate, { to: "../access", replace: true }) }), _jsx(Route, { path: "access", element: _jsx(AccessCenterPage, { areas: areas, accessMap: accessMap, userRole: user?.role, refreshAccess: () => {
                                    loadAreas();
                                    loadAccess();
                                } }) }), _jsx(Route, { path: "documents", element: _jsx(DocumentsPage, { areaId: selectedAreaId, canManage: canManageArea, areas: areas, onSelectArea: (id) => setSelectedAreaId(id) }) }), _jsx(Route, { path: "case-studies", element: _jsx(CaseStudiesPage, {}) }), _jsx(Route, { path: "knowledge-base", element: _jsx(KnowledgeBasePage, {}) }), _jsx(Route, { path: "documents/:docId", element: _jsx(DocumentDetailsPage, { areas: areas, canManage: canManageArea, onSelectArea: (id) => setSelectedAreaId(id) }) }), _jsx(Route, { path: "playground", element: _jsx(PlaygroundPage, {}) }), _jsx(Route, { path: "analytics", element: _jsx(AnalyticsPanel, { areaId: selectedAreaId, areas: areas }) }), _jsx(Route, { path: "ask", element: _jsx(AskAIPage, { areas: areas, selectedAreaId: selectedAreaId, onSelectArea: (id) => setSelectedAreaId(id) }) }), _jsx(Route, { path: "admin/users", element: user?.role === "SUPER_ADMIN" ? (_jsx(UsersPanel, { onToast: pushToast, refreshMyAccess: () => {
                                    loadAreas();
                                    loadAccess();
                                } })) : (_jsx(Navigate, { to: `/${locale}/documents`, replace: true })) }), _jsx(Route, { path: "admin/tags", element: user?.role === "SUPER_ADMIN" || user?.role === "ADMIN" ? (_jsx(TagsAdminPage, {})) : (_jsx(Navigate, { to: `/${locale}/knowledge-base`, replace: true })) }), _jsx(Route, { path: "admin/verify", element: user?.role === "SUPER_ADMIN" || user?.role === "ADMIN" ? (_jsx(VerifyPage, {})) : (_jsx(Navigate, { to: `/${locale}/dashboard`, replace: true })) }), _jsx(Route, { path: "admin/requests", element: user?.role === "SUPER_ADMIN" ? (_jsx(AccessRequestsPanel, { onToast: pushToast, refreshMyAccess: () => {
                                    loadAreas();
                                    loadAccess();
                                } })) : (_jsx(Navigate, { to: `/${locale}/documents`, replace: true })) }), _jsx(Route, { path: "admin/settings", element: user?.role === "SUPER_ADMIN" ? (_jsx("div", { className: "card", children: _jsxs("div", { className: "emptyState", children: [_jsx("div", { className: "emptyTitle", children: tDash("settings.comingSoonTitle") }), _jsx("div", { className: "emptyText", children: tDash("settings.comingSoonText") })] }) })) : (_jsx(Navigate, { to: `/${locale}/documents`, replace: true })) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: `/${locale}/dashboard`, replace: true }) })] }) }), _jsx(Toast, { toast: toast })] }));
}
